...
try:
    from python.link_to_sasmodels import get_model_list, get_params, get_structure_list
    ...
    from webcalc.python.link_to_sasmodels import get_model_list, get_params, get_structure_list
